const CACHE_NAME = 'tarun-portfolio-v1';
const urlsToCache = [
  '/',
  '/images/profile/Avatar.png',
  '/images/projects/MondayMarketplaceApp.png',
  '/images/projects/BetterCommerce.png',
  '/images/projects/AIContentPlatform.png',
  '/images/projects/AITravelPlanner.png',
  '/images/projects/Blogged.png',
  '/images/projects/DIYAI.png',
...
self.addEventListener('push', (event) => {
  const options = {
    ...
    badge: '/images/profile/Avatar.png',
    vibrate: [100, 50, 100],
    data: {
  ...
  event.waitUntil(
    self.registration.showNotification('Tarun Singh Portfolio', options)
  );
});
